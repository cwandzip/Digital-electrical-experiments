...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"seg_o", false,-1, 7,0);
    ...
    tracep->declBit(c+4,"flag", false,-1);
    tracep->declBus(c+5,"seg_o", false,-1, 7,0);
    tracep->declBus(c+6,"encode83_y", false,-1, 2,0);
    ...
    tracep->pushNamePrefix("seg ");
    tracep->declBus(c+6,"b", false,-1, 2,0);
    tracep->declBus(c+5,"h", false,-1, 7,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelf->seg_o),8);
    bufp->fullCData(oldp+6,(vlSelf->top__DOT__encode83_y),3);
}
