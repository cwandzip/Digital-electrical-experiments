...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+61,(vlSelf->state),4);
    bufp->chgCData(oldp+62,(vlSelf->top__DOT__state_din),4);
    ...
    __Vtemp_h4489e183__0[2U] = ((IData)(vlSelf->in)
                                 ? 5U : 1U);
    bufp->chgWData(oldp+63,(__Vtemp_h4489e183__0),72);
    bufp->chgCData(oldp+66,(vlSelf->top__DOT__stateMux__DOT__i0__DOT__lut_out),4);
    bufp->chgBit(oldp+67,(vlSelf->top__DOT__stateMux__DOT__i0__DOT__hit));
}
